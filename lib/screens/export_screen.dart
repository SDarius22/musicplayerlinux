...
//     var query = DataController.playlistBox.query(Playlist_.indestructible.equals(false)).order(Playlist_.name).build();
//     return Scaffold(
//       body: Container(
//         width: width,
//         height: height,
...
//                         if(i == 0){
//                           Playlist queuePlaylist = Playlist();
//                           queuePlaylist.name = "Current Queue";
//                           queuePlaylist.pathsInOrder = SettingsController.queue;
...
//                                     heroTag: "${playlist.pathsInOrder.first} $index",
//                                   ),
