...
//           future: Future(() async {
//             List<Song> songs = [];
//             for (var path in widget.playlist.pathsInOrder) {
...
//                                       child: FutureBuilder(
//                                         future: WorkerController.getImage(widget.playlist.pathsInOrder.first),
...
//                                     onTap: () async {
//                                       if(SettingsController.queue.equals(widget.playlist.pathsInOrder) == false){
//                                         dc.updatePlaying(widget.playlist.pathsInOrder, index);
//                                       }
