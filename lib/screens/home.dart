...
import 'package:musicplayer/song_player_widget.dart';
                                ...
                                Expanded(
                                    child: Container(
                                        ...
                                        child: ElevatedButton(onPressed: (){
                                          ...
                                          setState(() {
                                            widget.controller.repo.songs.value.sort((a, b) => a.title.replaceAll(RegExp('[^A-Za-z0-9]'), '').toLowerCase().compareTo(b.title.replaceAll(RegExp('[^A-Za-z0-9]'), '').toLowerCase()));
                                            create = false;
                                            playlistname = "New playlist";
                                            artistsforalbum = "";
                                            if(_scrollController.positions.isNotEmpty) {
                            ...
                            ValueListenableBuilder(
                                ...
                                builder: (context, value, child) {
                                  return LinearProgressIndicator(
                                    ...
                                    value: widget.controller.progressNotifier
                                        .value,
                                  );
                                }
                            );
