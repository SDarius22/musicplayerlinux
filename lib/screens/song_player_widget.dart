...
class _SongPlayerWidget extends State<SongPlayerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiValueListenableBuilder(
      valueListenables: [widget.controller.minimizedNotifier, widget.controller.indexNotifier, widget.controller.imageNotifier, widget.controller.hiddenNotifier],
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              padding: EdgeInsets.only(
                ...
                top: values[0] ? height * 0.02 : height * 0.15,
              ),
              margin: EdgeInsets.only(
                bottom: values[0] ? height * 0.02 : 0,
              ),
